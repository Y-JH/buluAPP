package com.bulu.cn.wiget.translucentscrollview;
...
/**
 * @Title:TranslucentScrollView
 * @Package:cn.com.zhongguancun.view.wiget.translucentscrollview
 * @Description:自定义ScrollView 和 渐变搭配效果
 * @Auther:YJH
...
public class TranslucentScrollView extends ScrollView {
    ...
    public void setTransView(View transView) {
        setTransView(transView, getResources().getColor(R.color.zgc_red),
                SizeUtils.dip2px(getContext(), DFT_TRANSSTARTY),
                SizeUtils.dip2px(getContext(), DFT_TRANSENDY));
    }

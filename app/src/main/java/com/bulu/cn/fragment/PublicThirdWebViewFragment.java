...
import com.bulu.cn.agent.IAndroidCallbackThirdAgent;
 ...
 * @Created time: 2018/09/26 09:45
 * @description: 由PublicActivityFroFragment承载所进入的新的三级webview页面，公共使用页面；
 */
public class PublicThirdWebViewFragment extends BaseBackFragment {
    private static final String TAG = "PublicSecondWebViewFragment";
    private WebAgentFragmentImpl mWebAgent;
    private static final String WEB_URL = "WEB_URL";
    public static PublicThirdWebViewFragment newInstance(String url) {

        Bundle args = new Bundle();
        PublicThirdWebViewFragment fragment = new PublicThirdWebViewFragment();
    ...
    private void initView(View view) {
        ...
        if (null != curAgentWeb) {
            ...
            curAgentWeb.getJsInterfaceHolder()
                    .addJavaObject("android", new IAndroidCallbackThirdAgent(curAgentWeb, this.getActivity()));
        }
    }
     ...
     */
    @Subscribe
    public void showAndroidNewThirdPage(IAndroidThirdPageEvent.NewPage event) {
        if(ConsActions.NEW_PAGE_EVENT.equals(event.NEW_PAGE_EVENT)){
//            startBrotherFragment(PublicFourthWebViewFragment.newInstance(event.pageUrl));
        }
    }
     ...
     */
    @Subscribe
    public void closeAndroidThirdPage(IAndroidThirdPageEvent.ClosePage event) {

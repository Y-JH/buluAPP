 ...
 */
public class ForgetPasswdFragment extends BaseBackFragment {
    private static final String TAG = "ForgetPasswdFragment";
    private WebAgentFragmentImpl mWebAgent;


    public static ForgetPasswdFragment newInstance() {
        Bundle args = new Bundle();
        ForgetPasswdFragment fragment = new ForgetPasswdFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String fileUrl = "file:///android_asset/buluApp/templates/login/forget.html";
    ...
    /**
     * 功能：eventbus 完成密码的重置，进入登录页面
     * @param event
     */
    @Subscribe
    public void onSetPasswdSucToLoginPage(IAndroidLoginPageEvent.SetFrogetPasswdSuccess event) {
